...
test('Pos_Fun_0004 - Simple sentence conversion.', async ({ page }) => {
...
test('Pos_Fun_0007 - Interrogative question form.', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0008 - Imperative command form.', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0009 - Negative sentence conversion.', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0012 - Response with negation.', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0013 - Polite apology/phrasing.', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0014 - Informal slang expression.', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0015 - Daily status expression.', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0016 - Multi-word collocation.', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0019 - Present tense with adverb.', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0020 - Simple negation pattern.', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
