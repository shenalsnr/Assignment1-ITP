...
tests/example.spec.ts: Automation script containing all 35 scenarios.


IT23818866_Assignment_1.xlsx: Completed Excel file with test case documentation.

playwright.config.ts: Configuration settings for the Playwright framework
"